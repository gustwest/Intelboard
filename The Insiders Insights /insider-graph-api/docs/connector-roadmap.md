...
|---|-----------|-------|--------|
| — | bolagsverket / linkedin / rss / website / gleif | (redan i drift) | ✅ |
| 1 | **GEO-riskloop** | Sondera beslutskritiska persona-frågor → skadeklassa svar → källförsedda korrigeringar + månadsrapport med Risk Exposure-trend ([spec](hallucination-loop-spec.md)) | 🟡 skiva 1 byggd (read-only) |
