        ...
        <Modal isOpen={isOpen} onClose={onClose} title="AI-Powered Import">
            <div className="space-y-4">
                {!result ? (
                    <>
                        <div
                            className="p-8 border-2 border-dashed border-border rounded-lg bg-muted hover:bg-muted transition-colors text-center cursor-pointer"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                className="w-full h-48 p-3 text-sm border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
                                placeholder={`Example:
...
- Logs (File)`}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-muted border border-border rounded-md max-h-64 overflow-y-auto p-4">
                            <div className="space-y-4">
                                {result.systems.map((sys, idx) => (
                                    <div key={idx} className="border-l-2 border-blue-500 pl-3">
                                        ...
                                        <div className="mt-2 text-xs text-slate-600 grid grid-cols-2 gap-1">
                                            ...
                                            {sys.assets.length > 6 && (
                                                <div className="text-muted-foreground italic">...and {sys.assets.length - 6} more</div>
                                            )}
                                        </div>
                                    </div>
                                ))}
