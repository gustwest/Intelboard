...
import { CreateSystemModal } from '@/components/modals/CreateSystemModal';
import { EditSystemModal } from '@/components/modals/EditSystemModal';
import { AssetModal } from '@/components/modals/AssetModal';
import { IntegrationDetailsModal } from '@/components/modals/IntegrationDetailsModal';
import { ProjectModal } from '@/components/modals/ProjectModal';
import { ManageProjectSystemsModal } from '@/components/modals/ManageProjectSystemsModal';
import { DataCatalogueModal } from '@/components/modals/DataCatalogueModal';
...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-full bg-white text-slate-900 overflow-hidden">
      <Sidebar
